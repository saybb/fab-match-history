...
1. Drop the "match_history.csv" file generated by the scraper in a folder called `data` in the root directory of this repository (TBD: supply filename as argument).
2. Run `datadoll.py`.
